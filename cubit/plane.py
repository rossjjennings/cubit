...
def rr_28pt():
    ...
    B1 = 8.176645817675417e-4 # == (481 - 133*sqrt(13))/5616*pi
    B2 = 4.363323129985824e-2 # == pi/72
    B3 = 0.5373255214498174 # == (481 + 133*sqrt(13))/5616*pi
...
def rr_28pt2():
    ...
    v. 23, 1969, pp. 765-779.
    '''
    r1 = 2.907364117106118 # Square roots of solutions
    r2 = 1.528230917660483 # of the cubic below:
    r3 = 0.6178819071436261 # 7375*x**3 - 82379*x**2 + 175968*x - 55584
    r4 = 1.904162039910276 # == sqrt((16+2*sqrt(22))/7)
    r5 = 0.9724173472297303 # == sqrt((16-2*sqrt(22))/7)
    r6 = 2.061552812808830 # == sqrt(17/4)
    s6 = 0.8660254037844387 # == sqrt(3/4)
    B1 = 4.106569066965604e-4
    B2 = 9.065690889492120e-2
    B3 = 0.5266955729327722
    B4 = 9.681125175723808e-4
    B5 = 0.1515812331366514
    B6 = 7.542839504417270e-3 # == 2/833*pi
